...
Se cumple que las perdidas se pueden modelar mediante la siguiente variable aleatoria
...
$$
\mathbb{P}\left(5000 > L \right)\Rightarrow \mathbb{P}\left(v^{K_[x]+1}>\frac{\ln\left(\frac{5000+\frac{P}{d}}{S+\frac{P}{d}}\right)}{\ln(v)} \right)
$$
...
$$
L=Sv^{K_[x+m]+1}-P\frac{1-v^{K_{[x+m]+1}}}{d}-\underbrace{P\frac{1+v^{m}}{d}}{a(m)}
$$ 
Donde $P$ es la prima neta, $S$ es el beneficio, $m$ es la cantidad de años que han pasado 
...
$$
\mathbb{P}\left(5000 > L \right)\Rightarrow \mathbb{P}\left(v^{K_[x]+1}>\frac{\ln\left(\frac{5000+\frac{P}{d}}{S+\frac{P}{d}}+a(m)\right)}{\ln(v)} \right)
$$
```{r}
