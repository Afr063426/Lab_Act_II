...
$$
\mathbb{P}\left(5000 < L \right)\Rightarrow \mathbb{P}\left(K_{[x]+1}>\frac{\ln\left(\frac{5000+\frac{P}{d}}{S+\frac{P}{d}}\right)}{\ln(v)} \right)
$$
...
$$
\mathbb{P}\left(5000 \geq L \right)\Rightarrow \mathbb{P}\left(K_{[x+m]}+1>\frac{\ln\left(\frac{5000+\frac{P}{d}}{S+\frac{P}{d}}+a(m)\right)}{\ln(v)} \right)
$$
