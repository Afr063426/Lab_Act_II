...
No se puede hablar de una tasa de riesgo al tenerse que el riesgo de que el individuo sobreviva o el que muera debido a los montos no están representados en igual proporción.
...
L2 <- benefit_1 * v_acum[11:21] - amount_payments[10]
...
<caption><center><strong>Figura 2: Fondos esperado final de año </strong></center></caption>
```{r,fig.align="center"}
...
Ahora suponiendo vidas independientes

$$
_tp_{xy}=_tp_x_tp_y \qquad _tp_{\overline{xy}}=_tp_x+_tp_y+_tp_{xy}
$$
