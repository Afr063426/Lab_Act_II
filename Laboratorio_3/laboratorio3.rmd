...
\ddot{a}_{\overline{35|}}\right)_{K}p_{25}^{\tau}q_{25+K}=0
\]
Entonces
\[
...
acumulado hasta ese periodo mediante la tasa de interés. Posteriormente las péridas son negativas
...
que conforme más viva la persona se vuelve más costosa. 
...
y los montos anteriormente recibos. Al tenerse una mayor cantidad en reservas que decrementos
